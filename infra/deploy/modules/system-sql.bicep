...
resource systemSqlServer 'Microsoft.Sql/servers@2024-11-01-preview' = {
  name: serverName
  location: location
  properties: {
    version: '12.0'
...
resource systemSqlDatabase 'Microsoft.Sql/servers/databases@2024-11-01-preview' = {
...
resource systemFirewallRuleAdmin 'Microsoft.Sql/servers/firewallRules@2023-05-01-preview' = if (!empty(adminClientIpAddress)) {
  parent: systemSqlServer
  name: 'AdminClientIp'
  properties: {
...
resource systemSqlPrivateEndpoint 'Microsoft.Network/privateEndpoints@2023-09-01' = {
  name: '${resourceNamePrefix}-system-sql-pe'
  location: location
  properties: {
    subnet: {
      id: dataSubnetId
    ...
    privateLinkServiceConnections: [
      {
        name: '${resourceNamePrefix}-system-sql-pls'
        properties: {
          privateLinkServiceId: systemSqlServer.id
          groupIds: [
            'sqlServer'
          ]
        }
